...
export default function PatientConfirmationEmail({
  patientName,
  doctorName,
  appointmentDate,
  meetLink,
      ...
      <Tailwind>
        <Body className="bg-gray-100 font-sans">
          <Container className="bg-white border border-gray-300 rounded-lg p-8 mx-auto my-8 max-w-lg">
            ...
            <Text className="text-gray-600 text-base">
              Your appointment has been successfully booked with <strong>{doctorName}</strong>. Here are the details:
            </Text>
            ...
            <Text className="text-gray-500 text-xs text-center">
              © 2026 HealthAI Medical Voice Agent. Please join 5 minutes before your appointment.
            </Text>
          </Container>
        </Body>
      </Tailwind>
