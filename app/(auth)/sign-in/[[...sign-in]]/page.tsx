...
export default function Page() {
  return (
    <div className='flex items-center justify-center min-h-screen bg-soft-gradient relative'>
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-bl from-sky-100/50 to-transparent rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-tr from-violet-100/40 to-transparent rounded-full blur-3xl" />
